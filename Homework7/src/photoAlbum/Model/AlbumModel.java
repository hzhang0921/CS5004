...
public class AlbumModel implements IAlbumModel {
  ...
  /**
   * Maps shape names to their instances for quick lookup and modification, while preserving insertion order.
   */
   ...
   */
  public AlbumModel() {
    this.shapes = new LinkedHashMap<>(); // Preserve insertion order
